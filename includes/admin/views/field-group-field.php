		...
		<div class="acf-field-editor">
			<div class="acf-field-settings acf-fields">
				...
				<div class="acf-field-settings-main acf-field-settings-main-general">
					...
					acf_render_field_setting(
						...
						array(
							...
							'label'        => __('Tiêu đề', 'acf'),
							// 'instructions' => __('This is the name which will appear on the EDIT page', 'acf'),
							'instructions' => __('Đây là tên sẽ xuất hiện trên trang chỉnh sửa', 'acf'),
							'name'         => 'label',
							'type'         => 'text',
							'class'        => 'field-label',
						),
					...
					acf_render_field_setting(
						$field,
						array(
							'label'        => __('Tên trường', 'acf'),
							// 'instructions' => __('Single word, no spaces. Underscores and dashes allowed', 'acf'),
							'instructions' => __('Một từ, không có dấu cách. Cho phép gạch dưới và gạch ngang', 'acf'),
							'name'         => 'name',
							'type'         => 'text',
							'class'        => 'field-name',
						),
				...
				<div class="acf-field-settings-footer">
					...
					<a class="button close-field edit-field" title="<?php _e('Đóng', 'acf'); ?>" href="#"><?php _e('Đóng', 'acf'); ?></a>
				</div>
			</div>
		</div>
	</div>
