...
acf_render_field_wrap(
	array(
		...
		'choices'      => array(
			...
			'default'  => __('Tiêu chuẩn (WP metabox)', 'acf'),
			'seamless' => __('Liền mạch (no metabox)', 'acf'),
		),
	)
);
...
acf_render_field_wrap(
	array(
		...
		'choices'       => array(
			...
			// 'side'            => __('Side', 'acf'),
			'acf_after_title' => __('Cao (bên trên tiêu đề)', 'acf'),
			'normal'          => __('Trung bình (Sau nội dung)', 'acf'),
			'side'            => __('Side', 'acf'),
		),
...
acf_render_field_wrap(
	array(
		...
		'choices'      => array(
			...
			'top'  => __('Căn trên cùng', 'acf'),
			'left' => __('Căn lề trái', 'acf'),
		),
	)
);
...
acf_render_field_wrap(
	array(
		...
		'choices'      => array(
			...
			'label' => __('Bên dưới nhãn', 'acf'),
			'field' => __('Bên dưới trường', 'acf'),
		),
	)
);
...
acf_render_field_wrap(
	array(
		'label'        => __('Số thứ tự', 'acf'),
		'instructions' => __('Nhóm trường có thứ tự thấp hơn sẽ xuất hiện trước', 'acf'),
		'type'         => 'number',
		'name'         => 'menu_order',
		'prefix'       => 'acf_field_group',
...
acf_render_field_wrap(
	array(
		...
		'instructions' => __('Hiển thị trong danh sách nhóm trường', 'acf'),
		'type'         => 'text',
		'name'         => 'description',
		'prefix'       => 'acf_field_group',
...
<div class="acf-field-group-settings-footer">
	...
	<a href="<?php echo get_delete_post_link(); ?>" class="acf-btn acf-btn-tertiary  acf-delete-field-group">
		...
		<?php esc_html_e('Xóa nhóm trường', 'acf'); ?>
	</a>
</div>
</div>
