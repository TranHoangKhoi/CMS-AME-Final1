	...
	<div class="acf-headerbar-inner">
		...
		<div class="acf-headerbar-content">
			...
			<div class="acf-title-wrap">
				...
				<input form="post" type="text" name="post_title" size="30" value="<?php echo esc_attr($post->post_title); ?>" id="title" class="acf-headerbar-title-field" spellcheck="true" autocomplete="off" placeholder="Tên trường" />
			</div>
		</div>
		...
		<div class="acf-headerbar-actions" id="submitpost">
			...
			<a href="#" class="acf-btn acf-btn-secondary add-field"><i class="acf-icon acf-icon-plus"></i>Thêm Trường mới</a>
			<button form="post" class="acf-btn acf-publish" type="submit">Lưu trường</button>
		</div>
