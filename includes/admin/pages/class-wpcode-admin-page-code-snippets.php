...
class WPCode_Admin_Page_Code_Snippets extends WPCode_Admin_Page
{
	...
	public function __construct()
	{
		...
		$this->page_title = __('Tùy Biến Code', 'insert-headers-and-footers');
		parent::__construct();
	}
...
<?php
	...
	public function output_header_bottom()
	{
		...
		$add_new_url = admin_url('admin.php?page=wpcode-snippet-manager&custom=1');
		?>
<div class="wpcode-column wpcode-title-button">
    <h1>
        <?php esc_html_e('Tất Cả Đoạn Code', 'insert-headers-and-footers'); ?>
    </h1>
    <a class="wpcode-button" href="<?php echo esc_url($add_new_url); ?>">
        <?php esc_html_e('Thêm Mới', 'insert-headers-and-footers'); ?>
    </a>
</div>
<?php
	}
