...
abstract class WPCode_Admin_Page
{
	...
	public function redirect()
	{
		if (is_admin()) {
			...
			var_dump($screen->base == 'tuy-bien-code_page_wpcode-snippet-manager');
			if (
				$screen->base == 'tuy-bien-code_page_wpcode-snippet-manager'
			) {
				// echo $screen->base;
				ob_start();
				wp_redirect(admin_url('admin.php?page=wpcode-snippet-manager&custom=1'));
	...
	public function hooks()
	{
		...
		// add_action('wpcode_admin_page', array($this, 'redirect'));
