...
function cptui_post_type_tabs($tabs = [], $current_page = '')
{
	...
	if ('post_types' === $current_page) {
		...
		$tabs['tabs']['add'] = [
			...
			'text' => __('Thêm Mới Post Type', 'custom-post-type-ui'),
			'classes' => $classes,
		...
		if (!empty($post_types)) {
			...
			$tabs['tabs']['edit'] = [
				...
				'text' => __('Sửa Post Types', 'custom-post-type-ui'),
				'classes' => $classes,
			...
			$tabs['tabs']['view'] = [
				'text' => __('Xem Post Types', 'custom-post-type-ui'),
				'classes' => ['nav-tab'],
				// Prevent notices.
			...
			$tabs['tabs']['export'] = [
				...
				'text' => __('Nhập/Xuất Post Types', 'custom-post-type-ui'),
				'classes' => ['nav-tab'],
				// Prevent notices.
																				...
																				<div class="postbox-container">
																					<div id="poststuff">
																						<div class="cptui-section postbox">
																							<div class="postbox-header">
																								<h2 class="hndle ui-sortable-handle">
																									<span><?php esc_html_e('Cài Đặt Cơ Bản', 'custom-post-type-ui'); ?></span>
																								</h2>
																							...
																							<div class="inside">
																								<div class="main">
																									<table class="form-table cptui-table">
																										...
																										echo $ui->get_label('name', esc_html__('Đường dẫn slug', 'custom-post-type-ui')); // phpcs:ignore.
																										echo $ui->get_required_span(); // phpcs:ignore.
																									
																										if ('edit' === $tab) {
																											echo '<p id="slugchanged" class="hidemessage">' . esc_html__('Slug đã thay đổi', 'custom-post-type-ui') . '<span class="dashicons dashicons-warning"></span></p>';
																										}
																										echo '<p id="slugexists" class="hidemessage">' . esc_html__('Slug đã tồn tại', 'custom-post-type-ui') . '<span class="dashicons dashicons-warning"></span></p>';
																										...
																										echo $ui->get_text_input(
																											...
																											[
																												...
																												'helptext' => esc_html__('Slug được sử dụng cho các truy vấn khác nhau nội dung bài đăng', 'custom-post-type-ui'),
																												'required' => true,
																												'placeholder' => false,
																												'wrap' => false,
																											]
																										...
																										esc_html_e('Slugs chỉ nên chứa các ký tự chữ và số, la tinh. Dấu gạch dưới nên được sử dụng thay cho khoảng trắng. Đặt trường "Custom Rewrite Slug" để làm cho slug sử dụng dấu gạch ngang cho URL.', 'custom-post-type-ui');
																										echo '</p>';
																										...
																										echo $ui->get_text_input(
																											...
																											[
																												...
																												// phpcs:ignore.
																												'labeltext' => esc_html__('Tiêu Đề', 'custom-post-type-ui'),
																												'aftertext' => esc_html__('(Trang chủ)', 'custom-post-type-ui'),
																												'helptext' => esc_html__('Được sử dụng làm tiêu đề menu admin.', 'custom-post-type-ui'),
																												'required' => true,
																											]
																										);
																										...
																										echo $ui->get_text_input(
																											...
																											[
																												...
																												// phpcs:ignore.
																												'labeltext' => esc_html__('Tiêu Đề Phụ', 'custom-post-type-ui'),
																												'aftertext' => esc_html__('(Trang chủ)', 'custom-post-type-ui'),
																												'helptext' => esc_html__('Được sử dụng làm tiêu đề phụ.', 'custom-post-type-ui'),
																												'required' => true,
																											]
																										);
																									...
																									<p class="submit">
																										...
																										<?php } else { ?>
																																												 ...
																																												 */
																																												?>
																																												<input type="submit" class="button-primary" name="cpt_submit" value="<?php echo esc_attr(apply_filters('cptui_post_type_submit_add', __('Thêm Post Type', 'custom-post-type-ui'))); ?>" />
																																											<?php
																										}
																						...
																						<div class="cptui-section cptui-labels postbox">
																							<div class="postbox-header">
																								<h2 class="hndle ui-sortable-handle">
																									<span><?php esc_html_e('Cài Đặt bổ xung', 'custom-post-type-ui'); ?></span>
																								</h2>
																								<div class="handle-actions hide-if-no-js">
																									<button type="button" class="handlediv" aria-expanded="true">
																										<span class="screen-reader-text"><?php esc_html_e('Toggle panel: Basic settings', 'custom-post-type-ui'); ?></span>
																									...
																									<table class="form-table cptui-table">
																										...
																										echo $ui->get_textarea_input(
																											...
																											[
																												...
																												// phpcs:ignore.
																												'labeltext' => esc_html__('Mô Tả', 'custom-post-type-ui'),
																												'helptext' => esc_html__('Gợi ý: post type của bạn được sử dụng để làm gì?', 'custom-post-type-ui'),
																											]
																										);
																										...
																										echo $ui->get_text_input(
																											// phpcs:ignore.
																											[
																												'labeltext' => esc_html__('Tên Menu', 'custom-post-type-ui'),
																												'helptext' => esc_html__('Tên menu tùy chỉnh cho post type.', 'custom-post-type-ui'),
																										...
																										echo $ui->get_text_input(
																											...
																											[
																												...
																												'data' => [
																													/* translators: Used for autofill */
																													'label' => 'item',
																													// not localizing because it's so isolated.
																													'plurality' => 'singular',
																												],
																											]
																										);
