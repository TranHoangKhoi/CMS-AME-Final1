...
$data = $wpdb->get_results("SELECT * FROM $table_shortcode WHERE post_name Like '%der'");
...
<?php if ($the_query->have_posts()) : ?>
    <h1 style="padding-top: 20px; font-weight: 900; font-size: 25px; color:#0d3380; margin-left: 0px;">TÙY BIẾN HEADER</h1>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <?php foreach( (array) $data as $key){?>
                            <tr>
                                ...
                                <td class="sc" hidden>[sc name="<?php echo $key -> post_name ?>"][/sc]</td>
                                <td>
                                    <div class="edit">
