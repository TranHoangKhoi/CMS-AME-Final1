...
class SC_Admin_Settings{
    ...
    public static function page(){
        ...
        $fields = array(
            ...
            array( __( 'Kiểu dữ liệu:', 'shortcoder' ), SC_Admin_Form::field( 'select', array(
                ...
                'helper' => __( 'Kiểu dữ liệu dành cho shortcode của bạn', 'shortcoder' )
            ))),
        ...
        echo '<p><button type="submit" class="button button-primary">Cập nhật</button></p>';
        echo '</form>';
    ...
    public static function save_settings(){
        ...
        if( $_POST && check_admin_referer( 'sc_settings_nonce' ) ){
            ...
            self::print_notice( 'Cập nhật thay đổi thành công' );
