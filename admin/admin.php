...
class SC_Admin{
    ...
    public static function register_post_type(){
        ...
        $labels = array(
            'name'                  => _x( 'AME Shortcoder', 'Post Type General Name', 'shortcoder' ),
            'singular_name'         => _x( 'Shortcode', 'Post Type Singular Name', 'shortcoder' ),
            'menu_name'             => __( 'AME Shortcoder', 'shortcoder' ),
            ...
            'all_items'             => __( 'Tất cả', 'shortcoder' ),
            'add_new_item'          => __( 'Thêm mới shortcode', 'shortcoder' ),
            'add_new'               => __( 'Tạo mới', 'shortcoder' ),
            'new_item'              => __( 'Mới', 'shortcoder' ),
    ...
    public static function register_taxonomy(){
        ...
        $labels = array(
            'name'                       => _x( 'Nhóm trang', 'Taxonomy General Name', 'shortcoder' ),
            'singular_name'              => _x( 'Nhóm trang', 'Taxonomy Singular Name', 'shortcoder' ),
            'menu_name'                  => __( 'Nhóm trang', 'shortcoder' ),
...
<div id="contextual-help-columns">
    ...
    public static function action_links( $links ){
        array_unshift( $links, '<a href="'. esc_url( admin_url( 'edit.php?post_type=shortcoder') ) .'">' . __( 'Chỉnh sửa', 'shortcoder' ) . '</a>' );
        return $links;
    }
